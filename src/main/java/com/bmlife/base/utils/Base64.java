...
public class Base64
{
    ...
    public static String encodeObject(java.io.Serializable serializableObject, int options)
    {
        ...
        {
            logger.error("����base64�������return null", e);
            return null;
        } // end catch
        finally
        {
        ...
        {
            logger.error("��֧�ֵı����ʽ������Ĭ�ϱ����ʽ���ַ���", uue);
    ...
    public static String encodeBytes(byte[] source, int off, int len, int options)
    {
        ...
        if ( gzip == GZIP )
        {
            ...
            {
                logger.error("�ֽ�����base64�������return null", e);
                return null;
            } // end catch
            finally
            {
    ...
    public static byte[] decode(String s, int options)
    {
        ...
        {
            logger.error("��֧�ֵı����ʽ��ʹ��Ĭ�ϱ����ʽ", uee);
            bytes = s.getBytes();
        } // end catch
        //</change>
    ...
    public static Object decodeToObject(String encodedObject)
    {
        ...
        {
            logger.error("û���ҵ�base64���������࣬return null", e);
            obj = null;
        } // end catch
        finally
        {
    ...
    public static boolean encodeFileToFile(String infile, String outfile)
    {
        ...
        {
            logger.error("��д�ļ�����return false", exc);
        }
        finally
        {
            try
